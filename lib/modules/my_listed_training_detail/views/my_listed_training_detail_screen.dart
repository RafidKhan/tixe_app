              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20.h),
                    GlobalMapViewWidget(
                      lat: double.tryParse(data?.trainingService?.lat ?? "0") ??
                          0,
                      lon: double.tryParse(data?.trainingService?.lon ?? "0") ??
                          0,
                    ),
                    SizedBox(height: 20.h),
                    _title("Description"),
                    ...
                    if (data?.trainingService?.gearsEquipments?.isNotEmpty ??
                      ...
                      ListView.builder(
                        ...
                        physics: const NeverScrollableScrollPhysics(),
                        itemCount:
                            data?.trainingService?.gearsEquipments?.length ?? 0,
                        itemBuilder: (context, index) {
                          final item =
