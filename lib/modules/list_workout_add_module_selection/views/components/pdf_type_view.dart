...
class PdfTypeView extends StatefulWidget {
  const PdfTypeView({super.key});

  @override
  State<PdfTypeView> createState() => _TextTypeViewState();
}

class _TextTypeViewState extends State<PdfTypeView> {
  @override
